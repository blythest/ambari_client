...
class AmbariCluster
  ...
  def clusters
    ...
    # returns an array
    res = JSON.parse(RestClient.get(@uri + "clusters/"))
  ...
  def cluster(cluster:)
    ...
    begin
      JSON.parse(RestClient.get(@uri + "clusters/#{cluster}"))
    rescue => err
      err.response
    end
  end
  ...
  def hosts(cluster:)
    ...
    # returns an array
    res = JSON.parse(RestClient.get(@uri + "clusters/#{cluster}/hosts/"))
  ...
  def service_components(cluster:, service:)
    ...
    res = JSON.parse(RestClient.get(@uri + "clusters/#{cluster}/services/#{service}/components/"))
  ...
  def service_component(cluster:, service:, component:)
    ...
    res = JSON.parse(RestClient.get(@uri + "clusters/#{cluster}/services/#{service}/components/#{component}/"))
    return res
  end
